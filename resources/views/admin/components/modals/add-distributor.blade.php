    ...
    <div id="admin-add" class="mfp-hide large">
        <div class="modal-data">
            <div class="modal-header">
                <h5 class="modal-title">{{ __("Add Distributor") }}</h5>
            </div>
            <div class="modal-form-data">
                <form class="modal-form" method="POST" action="{{ setRoute('admin.merchants.merchant.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-10-none">
                        {{-- <div class="col-xl-12 col-lg-12 form-group">
                            <label for="countryFlag">{{ __("Distributor Profile Image") }}</label>
