...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#choose-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-choose-item')

    {{-- Chhose Item Edit Modal --}}
    <div id="choose-edit" class="mfp-hide large">
...
@push('script')
 <script src="{{ asset('backend/js/fontawesome-iconpicker.js') }}"></script>
    ...
    <script>
        openModalWhenError("choose-add","#choose-add");
        openModalWhenError("choose-edit","#choose-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            openModalBySelector("#choose-edit");
