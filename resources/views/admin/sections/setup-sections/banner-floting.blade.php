...
@section('content')
                                ...
                                @foreach ($languages as $item)
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif" id="{{ $item->name }}" role="tabpanel" aria-labelledby="english-tab">
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.textarea',[
                                                'label'     =>__(  "Sub Title")."*",
                                                'name'      => $item->code . "_sub_title",
                                                'value'     => old($item->code . "_sub_title",$data->value->language->$lang_code->sub_title ?? "")
                                            ])
                                        </div>
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#floting-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Activities ") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.banner-floting-add')

    {{-- Solution Item Edit Modal --}}
    <div id="floting-edit" class="mfp-hide large">
        <div class="modal-data">
            <div class="modal-header px-0">
                <h5 class="modal-title">{{ __("Edit Activities")."*" }}</h5>
            </div>
...
@push('script')
    ...
    <script>
        openModalWhenError("floting-add","#floting-add");
        openModalWhenError("floting-edit","#floting-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            openModalBySelector("#floting-edit");
