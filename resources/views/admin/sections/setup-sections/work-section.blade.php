...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#work-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{__("Add Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-work-item')

    {{-- Solution Item Edit Modal --}}
    <div id="work-edit" class="mfp-hide large">
...
@push('script')
 <script src="{{ asset('backend/js/fontawesome-iconpicker.js') }}"></script>
    ...
    <script>
        openModalWhenError("work-add","#work-add");
        openModalWhenError("work-edit","#work-edit");
