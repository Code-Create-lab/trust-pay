...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#security-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-security-item')

    {{-- security Item Edit Modal --}}
    <div id="security-edit" class="mfp-hide large">
...
@push('script')
 <script src="{{ asset('backend/js/fontawesome-iconpicker.js') }}"></script>
    ...
    <script>
        openModalWhenError("security-add","#security-add");
        openModalWhenError("security-edit","#security-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            openModalBySelector("#security-edit");
