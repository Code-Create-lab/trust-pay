...
@section('content')
    <div class="table-area">
        <div class="table-wrapper">
            ...
            <div class="table-header">
                <h5 class="title">{{ __("Setup Commission") }}</h5>

            </div>
            <div class="table-responsive">
                @include('admin.components.data-table.commission-table',[
                    'data'  => $currencies
                ])
            </div>
        </div>
    ...
    {{-- Currency Edit Modal --}}
    @include('admin.components.modals.edit-commission')
