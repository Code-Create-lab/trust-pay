...
<section class="banner-section bg_img" data-background="{{ asset('frontend/') }}/images/banner/bg-1.jpg">
                ...
                <div class="banner-content">
                    ...
                    <div class="app-btn-area">
                        ...
                        <a href="{{ @$app_urls->iso_url }}" class="app-btn" target="_blank">
                            <div class="icon">
                                <img src="{{ asset('frontend/') }}/images/app/apple-store.png" alt="play-store">
                            </div>
                            <div class="content">
