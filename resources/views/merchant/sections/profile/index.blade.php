        ...
        <div class="row mb-20-none">
                            ...
                            <div class="profile-settings-wrapper">
                                <div class="preview-thumb profile-wallpaper">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview merchant bg_img" data-background="{{ asset('frontend/') }}/images/element/virtual-card.png"></div>
                                    </div>
                                </div>
            ...
            <div class="col-xl-6 col-lg-6 mb-20">
                <div class="custom-card mt-10">
                    ...
                    <div class="card-body">
                        <form class="card-form" action="{{ setRoute('merchant.profile.password.update') }}" method="POST">
                            @csrf
                            @method("PUT")
                            <div class="row">
...
@push('script')
    <script>
        getAllCountries("{{ setRoute('global.countries.merchant') }}");
