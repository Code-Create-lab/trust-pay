...
<div class="body-wrapper payment-body-wrapper">
    <div class="custom-card payment-card">
        <div class="payment-type-wrapper">
            ...
            <form action="{{ setRoute('merchant.payment-link.update') }}" class="payment-form" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade" id="mobile" role="tabpanel" aria-labelledby="mobile-tab">
                    <div class="payment-preview-mockup">
                        <img src="{{ asset('frontend/') }}/images/element/mockup.png" alt="element">
                                    ...
                                    <div class="col-xl-12 form-group">
                                        <div class="preview-check-group">
                                            <div class="custom-check-group">
                                                ...
                                                <label for="level-3">{{ __('Securely save my information  for 1-click checkout') }} <span>{{ __("Pay faster on") }} {{ Auth::user()->address->company_name ?? '' }} {{ __("and everywhere Link is accepted") }}</span></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 form-group pt-10">
